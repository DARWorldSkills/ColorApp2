...
public class JuegoC extends AppCompatActivity implements OnClickListener{
    ...
    private void endGame() {
        if (ab==0 && ((segundos[1]==0 || incorrectas==3 ) && modoJuego==1 || (modoJuego==2 && incorrectas==3)) ){
            bandera=false;
    ...
    private void inputValues() {
        ...
        timepoPalabra = juegoC.getInt("tiempo",3);
        correctas =0;
        incorrectas=0;
        porcentaje=0;
        intentos=0;
